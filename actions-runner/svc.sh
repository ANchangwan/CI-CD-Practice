...
SVC_NAME="actions.runner.ANchangwan-CI-CD-Practice.anchang-wan-ui-MacBookPro"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (ANchangwan-CI-CD-Practice.anchang-wan-ui-MacBookPro)"
